...
## ✨ Features
- **Effects**: Helium (High Pitch), Giant (Low Pitch), Robot, Cave (Reverb).
- **Premium UI**: Glassy design inspired by iOS 17.
- **Visualizer**: Real-time audio waveform.
- **Instant Share**: Uses Native Share Sheet (`navigator.share`) for fast sharing.
